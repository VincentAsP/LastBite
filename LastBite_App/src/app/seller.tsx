...
// ─── Constants ───
const CATEGORIES = ['Homemade', 'Bakery', 'Sisa Hari Ini', 'Snack', 'Minuman'];
const SALES_DATA = [
  { day: 'M', value: 7 },
  { day: 'T', value: 11 },
  { day: 'W', value: 6 },
...
// Dummy data history makanan yang pernah dijual
type SoldItem = {
  id: string;
  name: string;
  category: string;
...
export default function SellerHomepage() {
  ...
  // Total revenue dari semua yang sold_out + sebagian dari active
      ...
      >
        ...
        {activeTab === 'add' && (
          <View style={styles.formCard}>
            ...
            <Text style={[styles.fieldLabel, { marginTop: 16 }]}>
              Original Price{' '}
              <Text style={styles.optional}>(optional, shown as strikethrough)</Text>
            </Text>
            <TextInput
              style={styles.input}
            ...
            <Text style={[styles.fieldLabel, { marginTop: 16 }]}>
              Available Until{' '}
              <Text style={styles.optional}>(today)</Text>
            </Text>
            <TextInput
              style={styles.input}
