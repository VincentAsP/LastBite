...
function OrderDetailModal({
  ...
  const paymentMethod: string =
    (order as any).paymentMethod ?? "BCA Virtual Account";
              ...
              <View
                style={[
                  ...
                  order.status === "completed"
                    ? modal.statusCompleted
                    : modal.statusCancelled,
                ]}
              >
                <Text
                  style={[
                    modal.statusText,
                    order.status === "completed"
                      ? modal.statusTextCompleted
                      : modal.statusTextCancelled,
                  ]}
                >
                  {order.status}
                </Text>
